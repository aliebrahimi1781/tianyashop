...
<script type="text/javascript">
	${symbol_dollar}(document).ready(function(){
		${symbol_dollar}("input[name='paytime_begin']").attr("class","easyui-datebox");
		${symbol_dollar}("input[name='paytime_end']").attr("class","easyui-datebox");
		${symbol_dollar}("input[name='buyprojectorg']").prev().css("width","105px");
	});
 </script>