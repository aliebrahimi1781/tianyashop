  ...
  <t:formvalid formid="messagefrom" dialog="true" usePlugin="password" layout="table" action="textTemplateController.do?doSave">
   ...
   <table style="width:600px;" cellpadding="0" cellspacing="1" class="formtable">
    <tr>
     ...
     <td class="value">
       <input id="templateName" class="inputxt" name="templateName"  value="${symbol_dollar}{templateName}" datatype="*" nullmsg="模板名称不能为空！">
    ...
    <tr>
     ...
     <td class="value">
          <textarea  rows="15" cols="80" name="content" id="content">${symbol_dollar}{content}</textarea>
          <br>
