...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.web.cgform.service.impl.build;
...
import ${package}.web.cgform.common.CommUtils;
import ${package}.web.cgform.common.SysVar;
...
import ${package}.web.cgform.service.build.DataBaseService;
...
import ${package}.core.util.DBTypeUtil;
...
public class DataBaseServiceImpl extends CommonServiceImpl implements DataBaseService{
	...
	private String formateSQl(String sql, Map<String, Object> params) {
		...
		if(sql.toLowerCase().indexOf(CgAutoListConstant.SQL_INSERT)!=-1){
			sql = sql.replace("${symbol_pound}{UUID}", UUIDGenerator.generate());
		}
		for (String key : params.keySet()) {
//            sql = sql.replace("${symbol_dollar}{" + key + "}", "'"+String.valueOf(params.get(key))+"'");
			sql = sql.replace("${symbol_pound}{" + key + "}",String.valueOf(params.get(key)));
		}
		return sql;
	}
	...
	private String replaceExtendSqlSysVar(String sql){
		sql = sql.replace("${symbol_pound}{sys.userid}", SysVar.userid.getSysValue())
				.replace("${symbol_pound}{sys.userkey}", SysVar.userkey.getSysValue())
				.replace("${symbol_pound}{sys.username}", SysVar.username.getSysValue())
				.replace("${symbol_pound}{sys.user_realname}", SysVar.userrealname.getSysValue())
				.replace("${symbol_pound}{sys.depid}", SysVar.department_id.getSysValue())
				.replace("${symbol_pound}{sys.depname}", SysVar.department_name.getSysValue())
				.replace("${symbol_pound}{sys.sysdate}", SysVar.sysdate.getSysValue())
				.replace("${symbol_pound}{sys.sysdtime}", SysVar.systime.getSysValue());
		return sql;
	}
