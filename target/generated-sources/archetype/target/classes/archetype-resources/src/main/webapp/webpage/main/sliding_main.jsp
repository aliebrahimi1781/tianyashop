...
//                var ${symbol_dollar}script = ${symbol_dollar}("script[src='plug-in/jquery/jquery-1.8.3.js']");
//                ${symbol_dollar}(${symbol_dollar}script).remove();
//                alert(${symbol_dollar}script.attr("src"));
			  ${symbol_dollar}(".dock_tool_theme").live("click",function(){
				  ${symbol_dollar}("${symbol_pound}themeSetting_wrap2").append("<div id='themeSetting_wrap' style='display:none;'></div>");
				  ${symbol_dollar}("${symbol_pound}themeSetting_wrap").html(${symbol_dollar}("${symbol_pound}themeSetting_wrap1").html());
				  ${symbol_dollar}("${symbol_pound}themeSetting_wrap").show();
			  })
            });
        </script>
	</head>
	 ...
	 <div id='themeSetting_wrap' style='display:none;'></div>
		...
		<div  id="themeSetting_wrap1" style="display:none;">			
				...
				<div id="themeSetting_body" class="themeSetting_body">	
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_blue" class="themeSetting_settingButton" id="themeSetting_theme_blue">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_pinky_night" class="themeSetting_settingButton" id="themeSetting_theme_pinky_night">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_green" class="themeSetting_settingButton" id="themeSetting_theme_green">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_wood1" class="themeSetting_settingButton" id="themeSetting_theme_wood1">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_wood2" class="themeSetting_settingButton" id="themeSetting_theme_wood2">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_universe" class="themeSetting_settingButton" id="themeSetting_theme_universe">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_metal" class="themeSetting_settingButton" id="themeSetting_theme_metal">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_pinky_light" class="themeSetting_settingButton" id="themeSetting_theme_pinky_light">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_pinky_flower" class="themeSetting_settingButton" id="themeSetting_theme_pinky_flower">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_christmas" class="themeSetting_settingButton" id="themeSetting_theme_christmas">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_2011" class="themeSetting_settingButton" id="themeSetting_theme_2011">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_blue1" class="themeSetting_settingButton" id="themeSetting_theme_blue1">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_spring_festival" class="themeSetting_settingButton" id="themeSetting_theme_spring_festival">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_blue_glow" class="themeSetting_settingButton themeSetting_selected" id="themeSetting_theme_blue_glow">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_green_glow" class="themeSetting_settingButton" id="themeSetting_theme_green_glow">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_orange_glow" class="themeSetting_settingButton" id="themeSetting_theme_orange_glow">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_valentinesDay" class="themeSetting_settingButton" id="themeSetting_theme_valentinesDay">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_cloud" class="themeSetting_settingButton" id="themeSetting_theme_cloud">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_gravity" class="themeSetting_settingButton" id="themeSetting_theme_gravity">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_7_7" class="themeSetting_settingButton" id="themeSetting_theme_7_7">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_teachersDay" class="themeSetting_settingButton" id="themeSetting_theme_teachersDay">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_midAutumn" class="themeSetting_settingButton" id="themeSetting_theme_midAutumn">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_lookUpSky" class="themeSetting_settingButton" id="themeSetting_theme_lookUpSky">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_grass" class="themeSetting_settingButton" id="themeSetting_theme_grass">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_childhood" class="themeSetting_settingButton" id="themeSetting_theme_childhood">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_skyBlue" class="themeSetting_settingButton" id="themeSetting_theme_skyBlue">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_dandelionDream" class="themeSetting_settingButton" id="themeSetting_theme_dandelionDream">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_paintingTime" class="themeSetting_settingButton" id="themeSetting_theme_paintingTime">
					...
					<a href="${symbol_pound}${symbol_pound}${symbol_pound}" themeid="theme_dreamSky" class="themeSetting_settingButton" id="themeSetting_theme_dreamSky">
		...
		<div class="taskbar_start_menu_container" id="startMenuContainer" _olddisplay="block" style="display: none;">  
			...
			<div uin="0" class="taskbar_start_menu_selfinfo" id="startMenuSelfInfo">       
				<div style="float: left; line-height: 15px;">
							 <span style="color: ${symbol_pound}6DB6D9">当前用户: </span>
							 <span style="color: ${symbol_pound}FFFFFF">${symbol_dollar}{userName }</span><br>
							 <span style="color: ${symbol_pound}6DB6D9">职务: </span>
							 <span style="color: ${symbol_pound}FFFFFF">${symbol_dollar}{roleName }</span>
				</div>
				<a title="反馈" href="${symbol_pound}${symbol_pound}${symbol_pound}" class="startMenuImg startMenuTopControl_support" cmd="support">&nbsp;</a>    
				<a title="锁定" href="${symbol_pound}${symbol_pound}${symbol_pound}" class="startMenuImg startMenuTopControl_lock" cmd="lock">&nbsp;</a>     
			</div>       
