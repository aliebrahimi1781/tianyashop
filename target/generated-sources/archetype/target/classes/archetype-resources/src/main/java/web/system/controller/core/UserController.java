...
import ${package}.core.common.model.json.ValidForm;
...
import ${package}.core.util.RoletoJson;
import ${package}.core.util.SetListSort;
...
import ${package}.tag.vo.datatable.DataTables;
...
public class UserController {
	...
	public ModelAndView changepasswordforuser(TSUser user, HttpServletRequest req) {
		if (StringUtil.isNotEmpty(user.getId())) {
			...
			idandname(req, user);
			${package}.core.util.LogUtil.info(user.getPassword()+"-----"+user.getRealName());
		}
	...
	public AjaxJson savenewpwdforuser(HttpServletRequest req) {
		...
		if (StringUtil.isNotEmpty(id)) {
			...
			${package}.core.util.LogUtil.info(users.getUserName());
