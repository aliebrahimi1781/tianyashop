...
import ${package}.web.cgreport.entity.core.CgreportConfigHeadEntity;
import ${package}.web.cgreport.page.core.CgreportConfigHeadPage;
import ${package}.web.cgreport.service.core.CgreportConfigHeadServiceI;
import ${package}.web.cgreport.entity.core.CgreportConfigItemEntity;
/**   
 * @Title: Controller
...
public class CgreportConfigHeadController extends BaseController {
	...
	public void datagrid(CgreportConfigHeadEntity cgreportConfigHead,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		${package}.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, cgreportConfigHead);
		try{
		//自定义追加查询条件
		}catch (Exception e) {
