...
<html>
<head>
<TITLE>weboffice演示页面${symbol_dollar}{webRoot}</TITLE>
<LINK href="${symbol_dollar}{webRoot}/plug-in/webOffice/style.css" type=text/css rel=stylesheet>
<SCRIPT src="${symbol_dollar}{webRoot}/plug-in/webOffice/main.js" type=text/javascript></SCRIPT>
<!-- --------------------=== 调用Weboffice初始化方法 ===--------------------- -->
...
function WebOffice1_NotifyCtrlReady() {
	...
	spnWebOfficeInfo.innerText="----   您电脑上安装的WebOffice版本为:V" + document.all.WebOffice1.GetOcxVersion() +"${symbol_escape}t${symbol_escape}t${symbol_escape}t本实例是根据版本V6044编写";
}
var flag=false;
...
<CENTER>
<DIV style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; BACKGROUND: ${symbol_pound}fff; PADDING-BOTTOM: 0px; MARGIN: -10px 0px 0px; WIDTH: 1024px; PADDING-TOP: 10px; HEIGHT: 750px" align=center>
<FORM name=myform>
<TABLE class=TableBlock width="90%">
	<TBODY>
		<TR class=TableHeader>
			<TD colSpan=2 valign=middle><font size=3> WebOffice演示页面(HTML)</font> <font color="${symbol_pound}ff0000" size=-1><Span ID=spnWebOfficeInfo align="right"></Span> </font></TD>
		</TR>
		<tr>
