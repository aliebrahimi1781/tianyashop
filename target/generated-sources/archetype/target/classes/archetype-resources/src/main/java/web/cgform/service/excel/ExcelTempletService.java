...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.web.cgform.service.excel;
	...
	public static String getCellValueString(Cell cell) {
	  ...
	  switch (cell.getCellType()) {
		   case Cell.CELL_TYPE_NUMERIC :
		    value = new DecimalFormat("0.${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}").format(cell.getNumericCellValue());
		    break;
