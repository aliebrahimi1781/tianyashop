  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" callback="@Override uploadFile" layout="table" action="weixinCmsStyleController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="templateName" name="templateName" type="text" value="${symbol_dollar}{weixinCmsStylePage.templateName}" readonly="readonly" style="width: 150px" class="inputxt" >
				...
				<tr>
					...
					<td class="value">
							<span class="btn btn-success fileinput-button">
					     	...
					     	<input id="reviewImgUrl" name="reviewImgUrl" type="hidden" value="${symbol_dollar}{weixinCmsStylePage.reviewImgUrl}" style="width: 300px" class="inputxt">
