...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.web.cgreport.service.impl.core;
...
public class CgreportConfigHeadServiceImpl extends CommonServiceImpl implements CgreportConfigHeadServiceI {
	 ...
	 */
 	public String replaceVal(String sql,CgreportConfigHeadEntity t){
 		...
 		sql  = sql.replace("${symbol_pound}{code}",String.valueOf(t.getCode()));
 		sql  = sql.replace("${symbol_pound}{name}",String.valueOf(t.getName()));
 		sql  = sql.replace("${symbol_pound}{cgr_sql}",String.valueOf(t.getCgrSql()));
