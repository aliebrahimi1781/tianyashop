...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="weixinCmsSiteList" checkbox="true" fitColumns="false" title="微站点信息" actionUrl="weixinCmsSiteController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="站点模板样式"  field="siteTemplateStyle"  dictionary="weixin_cms_style,id,template_name,accountid='${symbol_dollar}{sessionScope.WEIXIN_ACCOUNT.id}'" hidden="true"  queryMode="single"  width="120"></t:dgCol>
