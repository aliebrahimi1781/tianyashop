...
import ${package}.poi.excel.annotation.ExcelCollection;
import ${package}.poi.excel.annotation.ExcelTarget;
import ${package}.poi.excel.entity.ComparatorExcelField;
import ${package}.poi.excel.entity.ExcelExportEntity;
import ${package}.poi.excel.entity.ExcelTitle;
import ${package}.poi.excel.entity.TemplateExportParams;
...
public final class ExcelExportUtil {
	...
	private static void createImageCell(Drawing patriarch, ExcelExportEntity entity, Row row,
		...
		if(entity.getExportImageType()==1){
			...
			try {
				String path = ContextHolderUtils.getRequest().getSession().getServletContext().getRealPath("${symbol_escape}${symbol_escape}") +string;
