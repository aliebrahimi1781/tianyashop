...
<script type="text/javascript">
        ...
        function uploadSuccess(d,file,response){
                ${symbol_dollar}("${symbol_pound}fileUrl").val(d.attributes.url);
                ${symbol_dollar}("${symbol_pound}fileName").val(d.attributes.name);
                var url = ${symbol_dollar}("${symbol_pound}fileUrl").val();
                var html="";
                ...
                ${symbol_dollar}("${symbol_pound}fileShow").html(html);
        }
        function uploadCallback(callback,inputId){
                var url = ${symbol_dollar}("${symbol_pound}fileUrl").val();
                var name= ${symbol_dollar}("${symbol_pound}fileName").val();
