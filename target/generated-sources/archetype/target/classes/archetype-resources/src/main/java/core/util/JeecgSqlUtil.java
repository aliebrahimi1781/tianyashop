...
import ${package}.core.def.ConstantsDefs;
...
public class JeecgSqlUtil {
	...
	private static String getFlieTxt(String fileUrl) {
		${package}.core.util.LogUtil.info("---------------------------------------sql 路径 :"+fileUrl);
		String sql = null;
		try {
	...
	public static String getMethodSqlLogic(String methodUrl){
		...
		${package}.core.util.LogUtil.info(sqlurl);
...
//		${package}.core.util.LogUtil.info(projectPath);
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
	...
	public static void main(String[] args) {
		//${package}.core.util.LogUtil.info(getAppPath(JeecgSqlUtil.class));
		${package}.core.util.LogUtil.info(getCountSqlBySql("SELECT * 	from JEECG_DICT_PARAM WHERE 1=1"));
	}
