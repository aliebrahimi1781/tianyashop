...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.web.cgform.controller.generate;
...
import ${package}.codegenerate.generate.CgformCodeGenerate;
import ${package}.codegenerate.generate.onetomany.CgformCodeGenerateOneToMany;
import ${package}.codegenerate.pojo.CreateFileProperty;
import ${package}.codegenerate.pojo.onetomany.CodeParamEntity;
import ${package}.codegenerate.pojo.onetomany.SubTableEntity;
import ${package}.codegenerate.util.CodeResourceUtil;
...
import ${package}.web.cgform.entity.generate.GenerateEntity;
import ${package}.web.cgform.entity.generate.GenerateSubListEntity;
import ${package}.web.cgform.service.button.CgformButtonServiceI;
...
public class GenerateController extends BaseController {
	...
	private void getCgformConfig(CgFormHeadEntity cgFormHead,
		...
		for(CgformButtonEntity cb:buttons){
			...
			buttonSqlMap.put(cb.getButtonCode(), cbs==null?new String[]{}:cbs.getCgbSqlStr().replaceAll("(${symbol_escape}r${symbol_escape}n|${symbol_escape}r|${symbol_escape}n|${symbol_escape}n${symbol_escape}r)", "").split(";"));
		}
		CgformButtonSqlEntity cbsAdd = cgformButtonSqlService.getCgformButtonSqlByCodeFormId("add", cgFormHead.getId());
		buttonSqlMap.put("add", cbsAdd==null?new String[]{}:cbsAdd.getCgbSqlStr().replaceAll("(${symbol_escape}r${symbol_escape}n|${symbol_escape}r|${symbol_escape}n|${symbol_escape}n${symbol_escape}r)", "").split(";"));
		CgformButtonSqlEntity cbsUpdate = cgformButtonSqlService.getCgformButtonSqlByCodeFormId("update", cgFormHead.getId());
		buttonSqlMap.put("update", cbsUpdate==null?new String[]{}:cbsUpdate.getCgbSqlStr().replaceAll("(${symbol_escape}r${symbol_escape}n|${symbol_escape}r|${symbol_escape}n|${symbol_escape}n${symbol_escape}r)", "").split(";"));
		CgformButtonSqlEntity cbsDelete = cgformButtonSqlService.getCgformButtonSqlByCodeFormId("delete", cgFormHead.getId());
		buttonSqlMap.put("delete", cbsDelete==null?new String[]{}:cbsDelete.getCgbSqlStr().replaceAll("(${symbol_escape}r${symbol_escape}n|${symbol_escape}r|${symbol_escape}n|${symbol_escape}n${symbol_escape}r)", "").split(";"));
		//JS增强-列表
