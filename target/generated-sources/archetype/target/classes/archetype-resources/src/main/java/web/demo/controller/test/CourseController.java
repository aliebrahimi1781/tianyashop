...
import ${package}.poi.excel.entity.vo.POIConstants;
...
import ${package}.poi.excel.ExcelExportUtil;
import ${package}.poi.excel.ExcelImportUtil;
import ${package}.poi.excel.ExcelUtil;
...
import ${package}.web.demo.entity.test.JpPersonEntity;
...
public class CourseController extends BaseController {
	...
	public void datagrid(CourseEntity course,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		${package}.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, course, request.getParameterMap());
