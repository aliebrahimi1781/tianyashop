...
public class ResourceUtil {
	...
	public static String getPorjectPath() {
		String nowpath; // 当前tomcat的bin目录的路径 如
						// D:${symbol_escape}java${symbol_escape}software${symbol_escape}apache-tomcat-6.0.14${symbol_escape}bin
		String tempdir;
		nowpath = System.getProperty("user.dir");
		tempdir = nowpath.replace("bin", "webapps"); // 把bin 文件夹变到 webapps文件里面
		tempdir += "${symbol_escape}${symbol_escape}"; // 拼成D:${symbol_escape}java${symbol_escape}software${symbol_escape}apache-tomcat-6.0.14${symbol_escape}webapps${symbol_escape}sz_pro
		return tempdir;
	}
	...
	public static void main(String[] args) {
		${package}.core.util.LogUtil.info(getPorjectPath());
		${package}.core.util.LogUtil.info(getSysPath());
