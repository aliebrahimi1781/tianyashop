...
<html>
 ...
 <body style="overflow-y: hidden" scroll="no">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="huodongController.do?save">
			<input id="id" name="id" type="hidden" value="${symbol_dollar}{huodongPage.id }">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="title" name="title" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.title}">
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="description" name="description" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.description}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="priceone" name="priceone" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.priceone}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="onetotal" name="onetotal" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.onetotal}" datatype="n">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="pricetwo" name="pricetwo" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.pricetwo}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="twototal" name="twototal" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.twototal}" datatype="n">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="pricethree" name="pricethree" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.pricethree}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="threetotal" name="threetotal" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.threetotal}" datatype="n">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="value">
						<input class="inputxt" id="count" name="count" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.count}" datatype="n">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width: 150px" id="starttime" name="starttime" ignore="ignore"
							     value="<fmt:formatDate value='${symbol_dollar}{huodongPage.starttime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
					...
					<td class="value">
						<input class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  style="width: 150px" id="endtime" name="endtime" ignore="ignore"
							     value="<fmt:formatDate value='${symbol_dollar}{huodongPage.endtime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
					<tr>
					...
					<td class="value">
						<input class="inputxt" id="gl" name="gl" ignore="ignore"
							   value="${symbol_dollar}{huodongPage.gl}">
						<span class="Validform_checktip"></span>
					</td>
				</tr>
				<tr>
