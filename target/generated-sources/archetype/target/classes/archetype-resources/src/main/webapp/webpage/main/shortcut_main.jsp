...
.tree-node-selected{
    background: ${symbol_pound}eaf2ff;
}
...
<SCRIPT type="text/javascript">
	...
	${symbol_dollar}(function() {
		${symbol_dollar}('${symbol_pound}layout_jeecg_onlineDatagrid').datagrid({
			...
			onLoadSuccess : function(data) {
				${symbol_dollar}('${symbol_pound}layout_jeecg_onlinePanel').panel('setTitle', '( ' + data.total + ' )人在线');
			}
		...
		${symbol_dollar}('${symbol_pound}layout_jeecg_onlinePanel').panel({
			tools : [ {
				iconCls : 'icon-reload',
				handler : function() {
					${symbol_dollar}('${symbol_pound}layout_jeecg_onlineDatagrid').datagrid('load', {});
				}
			} ]
		});
		
		${symbol_dollar}('${symbol_pound}layout_east_calendar').calendar({
			fit : true,
			current : new Date(),
			border : false,
			onSelect : function(date) {
				${symbol_dollar}(this).calendar('moveTo', new Date());
			}
		});
		${symbol_dollar}(".layout-expand").click(function(){
			${symbol_dollar}('${symbol_pound}layout_east_calendar').css("width","auto");
			${symbol_dollar}('${symbol_pound}layout_east_calendar').parent().css("width","auto");
			${symbol_dollar}("${symbol_pound}layout_jeecg_onlinePanel").find(".datagrid-view").css("max-height","200px");
			${symbol_dollar}("${symbol_pound}layout_jeecg_onlinePanel .datagrid-view .datagrid-view2 .datagrid-body").css("max-height","180px").css("overflow-y","auto");
		});
	});
	var onlineInterval;
    ...
    function panelCollapase(){
        ${symbol_dollar}(".easyui-layout").layout('collapse','north');
    }
...
<!-- 顶部-->
<div region="north" border="false" title="" style="BACKGROUND: ${symbol_pound}A8D7E9; height: 100px; padding: 1px; overflow: hidden;">
	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr style="height: 25px;" align="right">
				...
				<div style="float: left; line-height: 25px; margin-left: 70px;"><span style="color: ${symbol_pound}386780">当前用户:</span> <span style="color: ${symbol_pound}FFFFFF">${symbol_dollar}{userName }</span>&nbsp;&nbsp;&nbsp;&nbsp; <span
					style="color: ${symbol_pound}386780">职务:</span> <span style="color: ${symbol_pound}FFFFFF">${symbol_dollar}{roleName }</span></div>
				<div style="float: left; margin-left: 18px;">
				<div style="right: 0px; bottom: 0px;"><a href="javascript:void(0);" class="easyui-menubutton" menu="${symbol_pound}layout_north_kzmbMenu" iconCls="icon-comturn" style="color: ${symbol_pound}FFFFFF">控制面板</a>&nbsp;&nbsp;<a
					href="javascript:void(0);" class="easyui-menubutton" menu="${symbol_pound}layout_north_zxMenu" iconCls="icon-exit" style="color: ${symbol_pound}FFFFFF">注销</a></div>
...
<div align="center" style="color: ${symbol_pound}CC99FF; padding-top: 2px">&copy; 版权所有 <span class="tip"><a href="http://www.${artifactId}.com" title="捷微JeeWx：免费开源微信公众账号开发平台">捷微JeeWx</a> (推荐谷歌浏览器，获得更快响应速度) 技术支持:<a href="http://www.jeecg.org" title="JEECG开源社区">JEECG 开源社区</a> </span></div>
</div>
