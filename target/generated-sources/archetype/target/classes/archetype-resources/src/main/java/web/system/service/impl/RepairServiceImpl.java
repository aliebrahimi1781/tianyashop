...
import ${package}.web.cgform.engine.FreemarkerHelper;
...
import ${package}.web.demo.entity.test.CKEditorEntity;
import ${package}.web.demo.entity.test.CourseEntity;
import ${package}.web.demo.entity.test.JeecgDemoCkfinderEntity;
import ${package}.web.demo.entity.test.JeecgJdbcEntity;
import ${package}.web.demo.entity.test.JeecgMatterBom;
...
import ${package}.web.demo.entity.test.TSStudent;
import ${package}.web.demo.entity.test.TeacherEntity;
import ${package}.web.system.dao.repair.RepairDao;
import ${package}.web.system.pojo.base.TSAttachment;
import ${package}.web.system.pojo.base.TSDemo;
...
import ${package}.web.system.pojo.base.TSOperation;
...
public class RepairServiceImpl extends CommonServiceImpl implements
	...
	private void repairCkFinder() {
		...
		String str = "<img alt=${symbol_escape}"${symbol_escape}" src=${symbol_escape}"/jeecg/userfiles/images/%E6%9C%AA%E5%91%BD%E5%90%8D.jpg${symbol_escape}" style=${symbol_escape}"height:434px; width:439px${symbol_escape}" /><br />${symbol_escape}r${symbol_escape}n可爱的小猫<br />${symbol_escape}r${symbol_escape}n<br />${symbol_escape}r${symbol_escape}n<strong><span style=${symbol_escape}"font-size:14.0pt${symbol_escape}">1</span></strong><strong><span style=${symbol_escape}"font-family:宋体; font-size:14.0pt; line-height:150%${symbol_escape}">．</span></strong><strong><span style=${symbol_escape}"font-size:14.0pt${symbol_escape}">CRM</span></strong><strong><span style=${symbol_escape}"font-family:宋体; font-size:14.0pt; line-height:150%${symbol_escape}">概述</span></strong><br />${symbol_escape}r${symbol_escape}n<strong><span style=${symbol_escape}"font-size:1${version}pt${symbol_escape}">1</span></strong><strong><span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">．</span></strong><strong><span style=${symbol_escape}"font-size:1${version}pt${symbol_escape}">1</span></strong><strong><span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">概念</span></strong>${symbol_escape}r${symbol_escape}n${symbol_escape}r${symbol_escape}n<p style=${symbol_escape}"line-height:150%; text-indent:24.0pt${symbol_escape}"><span style=${symbol_escape}"color:black; font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">CRM</span><span style=${symbol_escape}"color:black; font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">是一项商业战略，它是按照客户细分原则有效的组织企业资源，来培养以客户为中心的</span><span style=${symbol_escape}"color:red; font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">经营行为以及实施以</span><span style=${symbol_escape}"color:black; font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">客户为中心的业务流程，以此为手段来提高企业的获利能力、收入及客户满意度。</span></p>${symbol_escape}r${symbol_escape}n${symbol_escape}r${symbol_escape}n<p style=${symbol_escape}"line-height:150%; text-indent:24.0pt${symbol_escape}"><span style=${symbol_escape}"color:black; font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">U8CRM</span><span style=${symbol_escape}"color:black; font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">同样是基于客户为中心应用原则，</span><span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">把客户作为企业最重要的资源，围绕客户的生命周期，从客户接触开始，到客户交易、客户服务的全程进行跟踪管理、过程监控，并通过对客户多角度分析，识别客户满足度和价值度，从而不断改进产品和服务，使客户价值最大化、终身化。</span></p>${symbol_escape}r${symbol_escape}n<strong><span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">1</span></strong><strong><span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:	150%${symbol_escape}">．2应用价值</span></strong>${symbol_escape}r${symbol_escape}n${symbol_escape}r${symbol_escape}n<p style=${symbol_escape}"line-height:150%; text-indent:24.0pt${symbol_escape}"><span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">统一企业的客户资源：系统帮助企业建立完整的客户、联系人资源档案，不同的组织、部门可以根据资源权限访问相关的客户资料。</span></p>${symbol_escape}r${symbol_escape}n<span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">深入挖掘价值客户：系统帮助用户建立价值评估体系，基于客户交易数据，多角度、全方位评估客户价值。通过客户价值的评估，挖掘价值客户，进而更好的服务价值客户。例如，帮助企业发现带来80%销售收入的20%价值客户。</span>${symbol_escape}r${symbol_escape}n${symbol_escape}r${symbol_escape}n<p style=${symbol_escape}"line-height:150%; text-indent:24.0pt${symbol_escape}"><span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">跟踪和监控销售机会：系统侧重售前业务管理，从客户向企业表达意向开始，围绕销售线索不同阶段，提供对商机客户购买意向、接触过程、竞争对手、阶段评估等信息的追踪记录，并通过销售漏斗有效监督整个销售过程是否正常。</span></p>${symbol_escape}r${symbol_escape}n${symbol_escape}r${symbol_escape}n<p style=${symbol_escape}"line-height:150%; text-indent:24.0pt${symbol_escape}"><span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">科学预测未来销售情况：提供了一种预测模式，系统可以按照销售商机的预期销售收入和预计成交时间，科学的预测未来可能实现的销售收入。</span></p>${symbol_escape}r${symbol_escape}n${symbol_escape}r${symbol_escape}n<p style=${symbol_escape}"line-height:150%; text-indent:24.0pt${symbol_escape}"><span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">提供科学理性的分析决策：系统提供基于客户完整业务（客户关系管理、供应链和财务）的决策分析，并通过报表的形式展现给用户，辅助企业做出数字化决策。</span></p>${symbol_escape}r${symbol_escape}n<span style=${symbol_escape}"font-family:宋体; font-size:1${version}pt; line-height:150%${symbol_escape}">资源共享：CRM系统与企业销售系统、财务系统等集成应用，实现企业信息化的整合和共享。</span><br />${symbol_escape}r${symbol_escape}n&nbsp;";
...
//		cgreport_head.setCreateDate(new Date());
		/*
		 * cgreport_head.setJsPlugIn("${symbol_dollar}(function(){"+"${symbol_escape}r${symbol_escape}n" +
		 * "${symbol_dollar}(${symbol_escape}"body${symbol_escape}").append(${symbol_escape}"<link href=${symbol_escape}${symbol_escape}${symbol_escape}"plug-in/lhgDialog/skins/default.css${symbol_escape}${symbol_escape}${symbol_escape}" rel=${symbol_escape}${symbol_escape}${symbol_escape}"stylesheet${symbol_escape}${symbol_escape}${symbol_escape}" id=${symbol_escape}${symbol_escape}${symbol_escape}"lhgdialoglink${symbol_escape}${symbol_escape}${symbol_escape}">${symbol_escape}");"
		 * +"${symbol_escape}r${symbol_escape}n" +
		 * "var ${symbol_dollar}btn = ${symbol_dollar}(${symbol_escape}"<div class=${symbol_escape}${symbol_escape}${symbol_escape}"ui_buttons${symbol_escape}${symbol_escape}${symbol_escape}"  style=${symbol_escape}${symbol_escape}${symbol_escape}"display:inline-block;${symbol_escape}${symbol_escape}${symbol_escape}"><input style=${symbol_escape}${symbol_escape}${symbol_escape}"position: relative;top: -8px;${symbol_escape}${symbol_escape}${symbol_escape}" class=${symbol_escape}${symbol_escape}${symbol_escape}"ui_state_highlight${symbol_escape}${symbol_escape}${symbol_escape}" type=${symbol_escape}${symbol_escape}${symbol_escape}"button${symbol_escape}${symbol_escape}${symbol_escape}" value=${symbol_escape}${symbol_escape}${symbol_escape}"sql解析${symbol_escape}${symbol_escape}${symbol_escape}"        id=${symbol_escape}${symbol_escape}${symbol_escape}"sqlAnalyze${symbol_escape}${symbol_escape}${symbol_escape}" /></div>${symbol_escape}");"
		 * +"${symbol_escape}r${symbol_escape}n" +"${symbol_dollar}(${symbol_escape}"${symbol_pound}cgr_sql${symbol_escape}").after(${symbol_dollar}btn);"+"${symbol_escape}r${symbol_escape}n"
		 * +"${symbol_dollar}btn.click(function(){"+"${symbol_escape}r${symbol_escape}n" +" ${symbol_dollar}.ajax({"+"${symbol_escape}r${symbol_escape}n"
		 * +"     url:${symbol_escape}"cgReportController.do?getFields${symbol_escape}","+"${symbol_escape}r${symbol_escape}n"
		 * +"    data:{sql:${symbol_dollar}(${symbol_escape}"${symbol_pound}cgr_sql${symbol_escape}").val()},"+"${symbol_escape}r${symbol_escape}n"
		 * +"   type:${symbol_escape}"Post${symbol_escape}","+"${symbol_escape}r${symbol_escape}n" +"    dataType:${symbol_escape}"json${symbol_escape}","+"${symbol_escape}r${symbol_escape}n"
		 * +"    success:function(data){"+"${symbol_escape}r${symbol_escape}n"
		 * +"      if(data.status==${symbol_escape}"success${symbol_escape}"){"+"${symbol_escape}r${symbol_escape}n"
		 * +"         ${symbol_dollar}(${symbol_escape}"${symbol_pound}add_jform_cgreport_item_table${symbol_escape}").empty();"+"${symbol_escape}r${symbol_escape}n"
		 * +"      ${symbol_dollar}.each(data.datas,function(index,e){"+"${symbol_escape}r${symbol_escape}n" +
		 * "        var ${symbol_dollar}tr = ${symbol_dollar}(${symbol_escape}"${symbol_pound}add_jform_cgreport_item_table_template tr${symbol_escape}").clone();"
		 * +"${symbol_escape}r${symbol_escape}n" +"      ${symbol_dollar}tr.find(${symbol_escape}"td:eq(1) :text${symbol_escape}").val(e);"+"${symbol_escape}r${symbol_escape}n"
		 * +"       ${symbol_dollar}tr.find(${symbol_escape}"td:eq(2) :text${symbol_escape}").val(index);"+"${symbol_escape}r${symbol_escape}n"
		 * +"       ${symbol_dollar}tr.find(${symbol_escape}"td:eq(3) :text${symbol_escape}").val(e);"+"${symbol_escape}r${symbol_escape}n"
		 * +"       ${symbol_dollar}(${symbol_escape}"${symbol_pound}add_jform_cgreport_item_table${symbol_escape}").append(${symbol_dollar}tr);"+"${symbol_escape}r${symbol_escape}n"
		 * +"      }); "+"${symbol_escape}r${symbol_escape}n"
		 * +"    resetTrNum(${symbol_escape}"add_jform_cgreport_item_table${symbol_escape}");"+"${symbol_escape}r${symbol_escape}n"
		 * +"    }"+"${symbol_escape}r${symbol_escape}n" +"  }"+"${symbol_escape}r${symbol_escape}n" +"  });"+"${symbol_escape}r${symbol_escape}n" +" });"+"${symbol_escape}r${symbol_escape}n" +"});");
...
//		commonDao.saveOrUpdate(cgreport_item);
		...
		/*
		 * ticket.setJsPlugIn(
		 * "${symbol_dollar}(${symbol_escape}"input/[name=${symbol_escape}'name${symbol_escape}']${symbol_escape}").change( function() { ${symbol_escape}r${symbol_escape}n 这里可以写些验证代码 ${symbol_escape}r${symbol_escape}n  var name = ${symbol_dollar}(${symbol_escape}"${symbol_pound}name${symbol_escape}").val();  ${symbol_escape}r${symbol_escape}nalert(name);});"
...
//		commonDao.saveOrUpdate(jform_cgreport_item_field_type);
	...
	private void repairCkEditor() {
		...
		String str = "<html><head><title></title><link href='plug-in/easyui/themes/default/easyui.css' id='easyuiTheme' rel='stylesheet' type='text/css' />"
				...
				+ "<style type='text/css'>body{font-size:12px;}table {border:1px solid ${symbol_pound}000000;border-collapse: collapse;}"
				+ "td {border:1px solid ${symbol_pound}000000;background:white;font-size:12px;font-family: 新宋体;color: ${symbol_pound}333;</style></head>"
				+ "<body><div><p>附件2：</p><h1 style='text-align:center'>"
				+ "<span style='font-size:24px'><strong>价格认证人员统计表</strong></span>"
				+ "</h1><p>填报单位（盖章）：<input name='org_name' type='text' value='${symbol_dollar}{org_name?if_exists?html}' /></p>"
				+ "<p>单位代码号：<input name='num' type='text' value='${symbol_dollar}{num?if_exists?html}' /> "
				+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
				+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
				+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
				+ "&nbsp;&nbsp;单位：人填&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
				...
				+ "<input name='tableName' type='hidden' value='${symbol_dollar}{tableName?if_exists?html}' /> "
				+ "<input name='id' type='hidden' value='${symbol_dollar}{id?if_exists?html}' />${symbol_pound}{jform_hidden_field}<input type='hidden' />"
				...
				+ "<tr><td><p><input name='a1' size='4' type='text' value='${symbol_dollar}{a1?if_exists?html}' /></p></td><td>"
				+ "<p><input name='b1' size='4' type='text' value='${symbol_dollar}{b1?if_exists?html}' /></p></td><td><p>"
				+ "<input name='b2' size='4' type='text' value='${symbol_dollar}{b2?if_exists?html}' /></p></td><td colspan='2'><p>"
				+ "<input name='b3' size='4' type='text' value='${symbol_dollar}{b3?if_exists?html}' /></p></td><td><p>"
				+ "<input name='b4' size='4' type='text' value='${symbol_dollar}{b4?if_exists?html}' /></p></td><td><p>"
				+ "<input name='b5' size='4' type='text' value='${symbol_dollar}{b5?if_exists?html}' /></p></td><td><p>"
				+ "<input name='c1' size='4' type='text' value='${symbol_dollar}{c1?if_exists?html}' /></p></td><td><p>"
				+ "<input name='c2' size='4' type='text' value='${symbol_dollar}{c2?if_exists?html}' /></p></td><td><p>"
				+ "<input name='c3' size='4' type='text' value='${symbol_dollar}{c3?if_exists?html}' /></p></td><td><p>"
				+ "<input name='c4' size='4' type='text' value='${symbol_dollar}{c4?if_exists?html}' /></p></td><td><p>"
				+ "<input name='c5' size='4' type='text' value='${symbol_dollar}{c5?if_exists?html}' /></p></td><td><p>"
				+ "<input name='d1' size='4' type='text' value='${symbol_dollar}{d1?if_exists?html}' /></p></td><td><p>"
				+ "<input name='d2' size='4' type='text' value='${symbol_dollar}{d2?if_exists?html}' /></p></td><td><p>"
				+ "<input name='d3' size='4' type='text' value='${symbol_dollar}{d3?if_exists?html}' /></p></td><td><p>"
				+ "<input name='d4' size='4' type='text' value='${symbol_dollar}{d4?if_exists?html}' /></p></td><td><p>"
				+ "<input name='e1' size='4' type='text' value='${symbol_dollar}{e1?if_exists?html}' /></p></td><td><p>"
				+ "<input name='e2' size='4' type='text' value='${symbol_dollar}{e2?if_exists?html}' /></p></td><td><p>"
				+ "<input name='e3' size='4' type='text' value='${symbol_dollar}{e3?if_exists?html}' /></p></td><td><p>"
				+ "<input name='e4' size='4' type='text' value='${symbol_dollar}{e4?if_exists?html}' /></p></td></tr>"
	...
	private void repairDemo() {
		...
		// 复杂字符串文本读取，采用文件方式存储
		String html = new FreemarkerHelper().parseTemplate("/${packageInPathFormat}/web/system/txt/valid-code-demo.ftl", null);
	...
	private void repaireIcon() {
		${package}.core.util.LogUtil.info("修复图标中");
	...
	private void repairMenu() {
		...
		TSIcon folder = commonDao.findByProperty(TSIcon.class, "iconName",
				"文件夹").get(0);
		${package}.core.util.LogUtil.info(defaultIcon.getIconPath());
