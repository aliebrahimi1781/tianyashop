...
import ${package}.core.common.model.json.Highchart;
	...
	public void export(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			if (null != type && null != svg) {
				...
				out
						.println("Usage:${symbol_escape}n${symbol_escape}tParameter [svg]: The DOM Element to be converted."
								+ "${symbol_escape}n${symbol_escape}tParameter [type]: The destination MIME type for the elment to be transcoded.");
			}
		} finally {
			if (out != null) {
				out.flush();
