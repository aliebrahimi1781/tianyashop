...
<t:datagrid name="newsitemslist" actionUrl="newsItemController.do?datagrid&templateId=${symbol_dollar}{templateId}" fit="true" fitColumns="true" idField="id" queryMode="group">
