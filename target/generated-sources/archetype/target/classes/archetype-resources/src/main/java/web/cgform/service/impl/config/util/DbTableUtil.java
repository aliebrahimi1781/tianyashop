...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.web.cgform.service.impl.config.util;
...
import ${package}.web.cgform.service.config.DbTableServiceI;
import ${package}.web.cgform.service.impl.config.DbTableMysqlHandleImpl;
import ${package}.web.cgform.service.impl.config.DbTableOracleHandleImpl;
import ${package}.web.cgform.service.impl.config.DbTablePostgresHandleImpl;
import ${package}.web.cgform.service.impl.config.DbTableServiceMysqlImpl;
import ${package}.web.cgform.service.impl.config.TableSQLServerHandleImpl;
