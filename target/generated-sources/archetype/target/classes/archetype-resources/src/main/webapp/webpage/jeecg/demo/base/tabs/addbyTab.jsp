...
<div style="float: left;"><a href="${symbol_pound}" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('弹出框添加','systemController.do?addNews')">弹出框打开添加页面</a> <a href="${symbol_pound}"
