...
<table style="display: none">
	<tbody id="add_cgreportConfigItem_table_template">
		<tr>
			...
			<td align="left"><t:dictSelect field="cgreportConfigItemList[${symbol_pound}index${symbol_pound}].fieldType" extendJson="{style:'width:80px'}" type="list" typeGroupCode="fieldtype" defaultVal="String" hasLabel="false" title="字段类型"></t:dictSelect></td>
			...
			<td align="left"><t:dictSelect field="cgreportConfigItemList[${symbol_pound}index${symbol_pound}].SMode"  extendJson="{style:'width:90px'}" type="list" typeGroupCode="searchmode" defaultVal="" hasLabel="false" title="查询模式"></t:dictSelect></td>
			...
			<td align="left"><t:dictSelect field="cgreportConfigItemList[${symbol_pound}index${symbol_pound}].SFlag"  extendJson="{style:'width:60px'}" type="list" typeGroupCode="yesorno" defaultVal="" hasLabel="false" title="是否查询"></t:dictSelect></td>
		</tr>
	</tbody>
</table>
</body>
