...
import ${package}.core.annotation.config.AutoMenu;
import ${package}.core.annotation.config.AutoMenuOperation;
import ${package}.core.annotation.config.MenuCodeType;
import ${package}.core.common.service.impl.CommonServiceImpl;
import ${package}.core.util.StringUtil;
import ${package}.minidao.factory.PackagesToScanUtil;
...
public class MenuInitServiceImpl extends CommonServiceImpl implements
	...
	private static final String MENU_TYPE_ID = "${symbol_pound}";//采用控件ID方式的code前缀
