...
<div style="float: left;"><a href="${symbol_pound}" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('DEMO录入','demoController.do?aorudemo','addDemoList')">弹出框方式添加</a> <a href="${symbol_pound}"
	class="easyui-linkbutton" plain="true" icon="icon-add" onclick="addbytab()">TAB方式添加</a> <a href="${symbol_pound}" class="easyui-linkbutton" plain="true" icon="icon-edit"
