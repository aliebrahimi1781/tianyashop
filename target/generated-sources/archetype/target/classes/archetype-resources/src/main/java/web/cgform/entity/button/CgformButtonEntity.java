...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.web.cgform.entity.button;
...
public class CgformButtonEntity implements java.io.Serializable {
	...
	/**显示表达式:exp="status${symbol_pound}eq${symbol_pound}0"*/
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  显示表达式:exp="status${symbol_pound}eq${symbol_pound}0"
	 */
	...
	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  显示表达式:exp="status${symbol_pound}eq${symbol_pound}0"
	 */
