...
<html>
 <head>
  ...
  ${symbol_dollar}(function () {
      ...
      //编辑时初始化图片预览
      var name = "${symbol_dollar}{adPage.title}", imageHref = "${symbol_dollar}{adPage.imageHref}";
      if(name != ""){
          ${symbol_dollar}("${symbol_pound}imageTitle").html(name);
      }
      if(imageHref != ""){
          ${symbol_dollar}("${symbol_pound}imageShow").html('<img src="${symbol_dollar}{adPage.imageHref}" width="100%" height="160" />');
      }
  });
 		...
 		<div class="media_edit_area" id="js_appmsg_editor">	
			<div class="appmsg_editor" style="margin-top: 0px;">
		 		<div class="inner">
					...
					<input id="id" name="id" type="hidden" value="${symbol_dollar}{adPage.id }">
					<input type="hidden" name="accountid" value="${symbol_dollar}{adPage.accountid}">
					<input type="hidden" name="imageName" id="imageName" value="${symbol_dollar}{adPage.imageName}">
					<table cellpadding="0" cellspacing="1" class="formtable">
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="title" name="title" style="width: 300px" value="${symbol_dollar}{adPage.title}" datatype="*" onblur="setimageTitle(this)">
						...
						<tr>
							...
							<td class="value">
							    ...
							    <input id="imageHref" name="imageHref" type="hidden" datatype="*" nullmsg="请添加图片" value="${symbol_dollar}{adPage.imageHref}">
