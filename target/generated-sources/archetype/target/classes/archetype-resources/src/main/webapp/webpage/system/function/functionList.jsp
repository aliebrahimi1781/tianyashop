...
{
	if(li_east == 0){
	   ${symbol_dollar}('${symbol_pound}system_function_functionList').layout('expand','east'); 
	}
	${symbol_dollar}('${symbol_pound}operationDetailpanel').panel("refresh", "functionController.do?operation&functionId=" +functionId);
}
<%--   update-end--Author:anchao  Date:20130415 for：按钮权限控制--%>
