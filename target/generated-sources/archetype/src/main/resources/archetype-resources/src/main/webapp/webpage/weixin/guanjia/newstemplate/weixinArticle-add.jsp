 			...
 			<div class="appmsg_editor" style="margin-top: 0px;">
	 			<div class="inner">
		  		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinArticleController.do?doAdd" tiptype="1">
							<input id="id" name="id" type="hidden" value="${symbol_dollar}{weixinArticlePage.id }">
							<input id="templateId" name="templateId" type="hidden" value="${symbol_dollar}{templateId}">
							<input id="createDate" name="createDate" type="hidden" value="${symbol_dollar}{weixinArticlePage.createDate }">
