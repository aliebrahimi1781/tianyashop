...
${symbol_pound}versionBar {
	background-color: ${symbol_pound}212121;
	position: fixed;
	width: 100%;
	height: 35px;
	bottom: 0;
...
.copyright {
	text-align: center;
	font-size: 10px;
	color: ${symbol_pound}CCC;
}

.copyright a {
	color: ${symbol_pound}A31F1A;
...
<body>
                        ...
                        <div style="float: right; padding: 3px 0; margin-right: -12px;">
                            <div>
                                <ul class="uibutton-group">
                                    <li><a class="uibutton normal" href="${symbol_pound}" id="but_login">登陆</a></li>
                                    <li><a class="uibutton normal" href="${symbol_pound}" id="forgetpass">重置</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="clear"></div>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; 版权所有 <span class="tip"><a href="http://www.${artifactId}.com" title="JEEWX 捷微：敏捷微信开发">捷微 JeeWx</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="http://www.jeecg.org" title="JEECG 开源社区">JEECG 开源社区</a></span></div>
    </div>
    <!-- Link JScript-->
