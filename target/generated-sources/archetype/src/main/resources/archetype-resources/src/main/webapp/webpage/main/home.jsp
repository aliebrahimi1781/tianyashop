 ...
 <link type="text/css" rel="stylesheet" href="./plug-in/weixin/css/style.css">
     <div class="funcList" id="func">
            <ul class="list">
                ...
                <a href="weixinShopController.do?goPage&page=index&openId=1234&accountid=${symbol_dollar}{sessionScope.WEIXIN_ACCOUNT.id}" target="_blank">
	                <li>
                ...
                <li>
                    <a href="zpController.do?goZhuanpan&accountid=${symbol_dollar}{sessionScope.WEIXIN_ACCOUNT.id}&openId=oGCDRjvr9L1NoqxbyXLReCVYVyV0" target="_blank">
                ...
                <li>
                	<a href="zpController.do?goGglNew&accountid=${symbol_dollar}{sessionScope.WEIXIN_ACCOUNT.id}&openId=oGCDRjvr9L1NoqxbyXLReCVYVyV0" target="_blank">
