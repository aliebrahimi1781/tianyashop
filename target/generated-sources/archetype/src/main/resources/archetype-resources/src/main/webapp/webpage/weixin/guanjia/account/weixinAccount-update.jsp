...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinAccountController.do?doUpdate" tiptype="1">
					<input id="id" name="id" type="hidden" value="${symbol_dollar}{weixinAccountPage.id }">
					<input id="addtoekntime" name="addtoekntime" type="hidden" value="${symbol_dollar}{weixinAccountPage.addtoekntime }"  />
					<input id="accountaccesstoken" name="accountaccesstoken" value="${symbol_dollar}{weixinAccountPage.accountaccesstoken }" type="hidden"/>
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="accountname" name="accountname" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinAccountPage.accountname}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accounttoken" name="accounttoken" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinAccountPage.accounttoken}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accountnumber" name="accountnumber" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinAccountPage.accountnumber}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="weixin_accountid" name="weixin_accountid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinAccountPage.weixin_accountid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <t:dictSelect field="accounttype" typeGroupCode="weixintype" hasLabel="false" defaultVal="${symbol_dollar}{weixinAccountPage.accounttype}"></t:dictSelect>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accountemail" name="accountemail" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinAccountPage.accountemail}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accountdesc" name="accountdesc" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinAccountPage.accountdesc}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accountappid" name="accountappid" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinAccountPage.accountappid}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="accountappsecret" name="accountappsecret" type="text" style="width: 150px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinAccountPage.accountappsecret}'>
							<span class="Validform_checktip"></span>
