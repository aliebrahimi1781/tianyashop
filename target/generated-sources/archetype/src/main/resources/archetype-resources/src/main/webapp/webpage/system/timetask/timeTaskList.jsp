...
<div region="center" style="padding: 1px;"><t:datagrid name="timeTaskList" title="定时任务管理" actionUrl="timeTaskController.do?datagrid" idField="id" fit="true">
	...
	<t:dgConfOpt title="运行" exp="isStart${symbol_pound}eq${symbol_pound}0" url="timeTaskController.do?startOrStopTask&id={id}&isStart=1" message="确认运行任务" />
	<t:dgConfOpt title="停止" exp="isStart${symbol_pound}eq${symbol_pound}1" url="timeTaskController.do?startOrStopTask&id={id}&isStart=0" message="确认停止" />
	<t:dgConfOpt title="立即生效" exp="isEffect${symbol_pound}eq${symbol_pound}0" url="timeTaskController.do?updateTime&id={id}" message="确认更新任务时间" />
