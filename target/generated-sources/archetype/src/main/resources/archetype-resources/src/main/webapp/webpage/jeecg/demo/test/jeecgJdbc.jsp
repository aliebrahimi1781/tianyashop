...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jeecgJdbcController.do?save">
	<input id="id" name="id" type="hidden" value="${symbol_dollar}{jeecgJdbcPage.id }">
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value"><input class="inputxt" id="depId" name="depId" ignore="ignore" value="${symbol_dollar}{jeecgJdbcPage.depId}"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="value"><input class="inputxt" id="sex" name="sex" ignore="ignore" value="${symbol_dollar}{jeecgJdbcPage.sex}"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
