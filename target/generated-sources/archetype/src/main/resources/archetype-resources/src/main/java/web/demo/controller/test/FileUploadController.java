...
import ${package}.web.demo.entity.test.FileMeta;
...
public class FileUploadController extends BaseController {
	...
	public LinkedList<FileMeta> upload(MultipartHttpServletRequest request, HttpServletResponse response) {
		...
		while (itr.hasNext()) {
			...
			${package}.core.util.LogUtil.info(mpf.getOriginalFilename() + " uploaded! " + files.size());
	...
	@RequestMapping(params = "view", method = {RequestMethod.GET,RequestMethod.POST})
	 public void get(HttpServletResponse response,String index){
		 ...
		 try {		
			 	...
			 	response.setHeader("Content-disposition", "attachment; filename=${symbol_escape}""+getFile.getFileName()+"${symbol_escape}"");
