...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinExpandconfigController.do?doUpdate" tiptype="1">
					<input id="id" name="id" type="hidden" value="${symbol_dollar}{weixinExpandconfigPage.id }">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="keyword" name="keyword" type="text" style="width: 150px" class="inputxt"  
									               datatype="*"
									                 value='${symbol_dollar}{weixinExpandconfigPage.keyword}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="classname" name="classname" type="text" style="width: 400px" class="inputxt"  
									               datatype="*"
									                 value='${symbol_dollar}{weixinExpandconfigPage.classname}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 200px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinExpandconfigPage.name}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="content" name="content" type="text" style="width: 200px" class="inputxt"  
									                 ...
									                 value='${symbol_dollar}{weixinExpandconfigPage.content}'>
							<span class="Validform_checktip"></span>
