...
<html>
    ...
    <head>
        ...
        <style>
            ${symbol_pound}nickname{overflow:hidden;white-space:nowrap;text-overflow:ellipsis;max-width:90%;}
            .page-toolarea a.random_empha{color:${symbol_pound}607fa6;} ol,ul{list-style-position:inside;}
            ${symbol_pound}activity-detail .page-content .text{font-size:16px;}
        </style>
    </head>
                ...
                <div class="header">
                    ...
                    <p class="activity-info">
                        <span id="post-date" class="activity-meta no-extra">
                            <fmt:formatDate value='${symbol_dollar}{newsItem.createDate}' type="date" pattern="yyyy-MM-dd"/>
                        </span>
            ...
            <div id="page-content" class="page-content" lang="en">
                <div id="img-content">
                    <div class="media" id="media">
                        <img  src="${symbol_dollar}{newsItem.imagePath}">
                    </div>
                    <div class="text" id="js_content">
                        ${symbol_dollar}{newsItem.content}
                    </div>
                    <p class="page-toolbar" id="js_toobar">
                        <a href="http://www.${artifactId}.com" class="page-imform">
                         	 捷微团队
                        </a>
                    </p>
                </div>
