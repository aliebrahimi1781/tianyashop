...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="generateController.do?dogenerate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value"><input type="text" class="inputxt" value="${symbol_dollar}{projectPath }" name="projectPath" id="projectPath" datatype="*" /> <a href="${symbol_pound}" id="openFoldSelect" class="easyui-linkbutton"
		...
		<tr>
			...
			<td class="value"><select id="jformType" disabled="disabled" name="jformType">
				...
				<option value="2" <c:if test="${symbol_dollar}{cgFormHeadPage.jformType eq '2'}"> selected="selected"</c:if>>一对多</option>
			</select></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="value" colspan="3"><input class="inputxt" id="entityName" name="entityName" value="${symbol_dollar}{entityNames[cgFormHeadPage.tableName]}" datatype="*"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
