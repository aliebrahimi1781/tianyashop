...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.core.extend.hqlsearch;
...
import ${package}.core.annotation.query.QueryTimeFormat;
import ${package}.core.common.hibernate.qbc.CriteriaQuery;
import ${package}.core.extend.hqlsearch.parse.IHqlParse;
import ${package}.core.extend.hqlsearch.parse.impl.BigDecimalParseImpl;
import ${package}.core.extend.hqlsearch.parse.impl.DoubleParseImpl;
import ${package}.core.extend.hqlsearch.parse.impl.FloatParseImpl;
import ${package}.core.extend.hqlsearch.parse.impl.IntegerParseImpl;
import ${package}.core.extend.hqlsearch.parse.impl.LongParseImpl;
import ${package}.core.extend.hqlsearch.parse.impl.ShortParseImpl;
import ${package}.core.extend.hqlsearch.parse.impl.StringParseImpl;
			...
			try {
				...
				if (type.contains("class java.lang")
					...
					if (isNotEmpty(param) && itIsNotAllEmpty(param)) {
						...
						cq.createAlias(aliasName, aliasName.replaceAll("${symbol_escape}${symbol_escape}.","_"));
