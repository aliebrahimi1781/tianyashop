...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" callback="@Override uploadFile" action="tFinanceController.do?save">
	<input id="id" name="id" type="hidden" value="${symbol_dollar}{tFinancePage.id }">
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			<td align="right"><label class="Validform_label"> 类别: </label></td>
			<td class="value"><input class="inputxt" id="category" name="category" ignore="ignore" value="${symbol_dollar}{tFinancePage.category}"> <span class="Validform_checktip"></span></td>
			<td align="right"><label class="Validform_label"> 年份: </label></td>
			<td class="value"><input class="inputxt" id="happenyear" name="happenyear" ignore="ignore" value="${symbol_dollar}{tFinancePage.happenyear}" datatype="n"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
			...
			<td class="value"><input class="Wdate" onClick="WdatePicker()" style="width: 150px" id="paytime" name="paytime" ignore="ignore"
				value="<fmt:formatDate value='${symbol_dollar}{tFinancePage.paytime}' type="date" pattern="yyyy-MM-dd"/>"> <span class="Validform_checktip"></span></td>
			<td align="right"><label class="Validform_label"> 收款单位: </label></td>
			<td class="value"><input class="inputxt" id="collectorg" name="collectorg" ignore="ignore" value="${symbol_dollar}{tFinancePage.collectorg}"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
			<td align="right"><label class="Validform_label"> 拨款文件类别: </label></td>
			<td class="value"><input class="inputxt" id="approfiletype" name="approfiletype" ignore="ignore" value="${symbol_dollar}{tFinancePage.approfiletype}"> <span class="Validform_checktip"></span></td>
			<td align="right"><label class="Validform_label"> 指标文号: </label></td>
			<td class="value"><input class="inputxt" id="zbwno" name="zbwno" ignore="ignore" value="${symbol_dollar}{tFinancePage.zbwno}"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
			<td align="right"><label class="Validform_label"> 金额合计: </label></td>
			<td class="value"><input class="inputxt" id="moneytotal" name="moneytotal" ignore="ignore" value="${symbol_dollar}{tFinancePage.moneytotal}" datatype="d"> <span class="Validform_checktip"></span></td>
			<td align="right"><label class="Validform_label"> 支出科目: </label></td>
			<td class="value"><input class="inputxt" id="expenseaccount" name="expenseaccount" ignore="ignore" value="${symbol_dollar}{tFinancePage.expenseaccount}"> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
