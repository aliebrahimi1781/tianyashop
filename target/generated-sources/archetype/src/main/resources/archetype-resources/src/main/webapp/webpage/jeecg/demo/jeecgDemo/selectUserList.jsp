...
<div region="center" style="padding: 1px;"><t:datagrid name="userList" title="用户管理" checkbox="true" actionUrl="userController.do?datagrid" fit="true" fitColumns="true" idField="id">
	...
	<t:dgCol title="部门" field="TSDepart_departname" query="true" queryMode="single" replace="${symbol_dollar}{departsReplace}"></t:dgCol>
...
<script type="text/javascript">
	function searchUserList(){
		${symbol_dollar}('${symbol_pound}userList').datagrid('reload',{
			userName: ${symbol_dollar}("${symbol_pound}userName").val(),
			TSDepart_departname: ${symbol_dollar}("${symbol_pound}TSDepart_departname").val(),
			realName:  ${symbol_dollar}("${symbol_pound}realName").val()
		});
	}
	function getSelectRows(){
		return ${symbol_dollar}('${symbol_pound}userList').datagrid('getChecked');
	}
</script>