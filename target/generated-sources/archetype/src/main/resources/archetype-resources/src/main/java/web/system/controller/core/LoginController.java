...
import ${package}.web.system.manager.ClientManager;
import ${package}.web.system.pojo.base.Client;
import ${package}.web.system.pojo.base.TSConfig;
...
import ${package}.core.extend.datasource.DataSourceContextHolder;
import ${package}.core.extend.datasource.DataSourceType;
import ${package}.core.util.ContextHolderUtils;
import ${package}.core.util.IpUtil;
import ${package}.core.util.ListtoMenu;
import ${package}.core.util.NumberComparator;
            ...
            if(function.getFunctionLevel() == 0){
                ...
                if("Online 开发".equals(function.getFunctionName())){
                    ...
                    if(function.getFunctionName().length()>=5 && function.getFunctionName().length()<7){
                        s = "<div style='width:67px;position: absolute;top:40px;text-align:center;color:${symbol_pound}909090;font-size:12px;'><span style='letter-spacing:-1px;'>"+ function.getFunctionName() +"</span></div>";
                    }else if(function.getFunctionName().length()<5){
                        s = "<div style='width:67px;position: absolute;top:40px;text-align:center;color:${symbol_pound}909090;font-size:12px;'>"+ function.getFunctionName() +"</div>";
                    }else if(function.getFunctionName().length()>=7){
                        s = "<div style='width:67px;position: absolute;top:40px;text-align:center;color:${symbol_pound}909090;font-size:12px;'><span style='letter-spacing:-1px;'>"+ function.getFunctionName().substring(0, 6) +"</span></div>";
                    }
