...
<html>
 <head>
  ...
  ${symbol_dollar}(function () {
      ...
      //编辑时初始化图片预览
      var name = "${symbol_dollar}{cmsArticlePage.title}", imageHref = "${symbol_dollar}{cmsArticlePage.imageHref}";
      if(name != ""){
          ${symbol_dollar}("${symbol_pound}imageTitle").html(name);
      }
      if(imageHref != ""){
          ${symbol_dollar}("${symbol_pound}imageShow").html('<img src="${symbol_dollar}{cmsArticlePage.imageHref}" width="100%" height="160" />');
      }
  });
 		...
 		<div class="media_edit_area" id="js_appmsg_editor">	
			<div class="appmsg_editor" style="margin-top: 0px;">
		 		<div class="inner">
					...
					<input id="id" name="id" type="hidden" value="${symbol_dollar}{cmsArticlePage.id }">
					<input type="hidden" name="accountid" value="${symbol_dollar}{cmsArticlePage.accountid}">
					<input type="hidden" name="imageName" id="imageName" value="${symbol_dollar}{cmsArticlePage.imageName}">
					<table cellpadding="0" cellspacing="1" class="formtable">
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="title" name="title" style="width: 300px" value="${symbol_dollar}{cmsArticlePage.title}" datatype="*" onblur="setimageTitle(this)">
						...
						<tr>
							...
							<td class="value">
								<t:dictSelect field="columnId" dictTable="weixin_cms_menu where accountid='${symbol_dollar}{sessionScope.WEIXIN_ACCOUNT.id}'" dictField="id" dictText="name" defaultVal="${symbol_dollar}{cmsArticlePage.columnId}"></t:dictSelect>
								<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
							    ...
							    <input id="imageHref" name="imageHref" type="hidden" nullmsg="请添加图片" value="${symbol_dollar}{cmsArticlePage.imageHref}">
						...
						<tr>
							...
							<td class="value">
								<textarea class="inputxt" id="summary" name="summary" style="width: 300px" datatype="*">${symbol_dollar}{cmsArticlePage.summary}</textarea>
								<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								 <textarea name="content" id="content" style="width: 350px;height:300px">${symbol_dollar}{cmsArticlePage.content}</textarea>
							    <script type="text/javascript">
