...
<script src="http://libs.baidu.com/jquery/${version}.0/jquery.min.js" type="text/javascript"></script>
...
<script type="text/javascript">
	${symbol_dollar}(document).ready(function(){
		...
		${symbol_dollar}("${symbol_pound}wScratchPad2").wScratchPad({
                ...
                if(percent > 60){
                	...
                	if(isfirst==0){
                	  if(prize=='1'){
	                    ...
	                    ${symbol_dollar}("${symbol_pound}card").slideUp(500);
		              }else if(prize=='2'){
		            	message = "恭喜你获得二等奖！";
		            	${symbol_dollar}("${symbol_pound}result").slideToggle(500);
	                    ${symbol_dollar}("${symbol_pound}card").slideUp(500);
...
<input class="pxbtn" id="save-btn" name="提 交" type="button" value="提 交">
	...
	<ul> 
		<li>一等奖：${symbol_dollar}{huodongEntity.priceone}，数量：${symbol_dollar}{huodongEntity.onetotal}</li>
		<li>二等奖：${symbol_dollar}{huodongEntity.pricetwo}，数量：${symbol_dollar}{huodongEntity.twototal}</li>
		<li>三等奖：${symbol_dollar}{huodongEntity.pricethree}，数量：${symbol_dollar}{huodongEntity.threetotal}</li>
	</ul>
	</div>
	<div class="int">
	<div class="tit"><img src="plug-in/weixin/images/ggl/2.png" width="100%"/></div>
	<p>${symbol_dollar}{huodongEntity.description}</p>
	</div>
	</div>
</body>
</html>