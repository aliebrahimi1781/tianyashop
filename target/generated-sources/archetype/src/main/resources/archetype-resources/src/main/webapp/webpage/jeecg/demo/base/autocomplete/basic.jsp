...
<!--
.ac_over {
	background: ${symbol_pound}E0ECFF;
	cursor: pointer;
	color: ${symbol_pound}416AA3;
}
...
<SCRIPT type="text/javascript">
        function parse(data){
            	var parsed = [];
		        	${symbol_dollar}.each(data.rows,function(index,row){
        ...
        function callBack(data) {
        	${symbol_dollar}("${symbol_pound}user").val(data.userName);
        }
