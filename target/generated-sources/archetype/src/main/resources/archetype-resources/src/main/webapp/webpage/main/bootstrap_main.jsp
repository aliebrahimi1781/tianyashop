...
<ul class="nav pull-right usernav">
	<li style="line-height: 43px;"><span style="color: ${symbol_pound}CC33FF">当前用户:</span><span style="color: ${symbol_pound}666633">(${symbol_dollar}{userName })</span> <span style="color: ${symbol_pound}CC33FF">职务</span>:<span style="color: ${symbol_pound}666633">${symbol_dollar}{roleName
	}</span></li>
	<li class="dropdown"><a href="${symbol_pound}" class="dropdown-toggle avatar" data-toggle="dropdown"> <i class="icon-wrench"></i> <span class="txt">控制面板</span> <b class="caret"></b> </a>
	...
	<li class="dropdown"><a href="${symbol_pound}" class="dropdown-toggle avatar" data-toggle="dropdown"> <i class="icon-arrow-left"></i> <span class="txt">注销</span> <b class="caret"></b> </a>
	<ul class="dropdown-menu">
