...
<div class="datagrid-toolbar" style="width:700px;padding:20px">
	...
	<table id="uploaded-files" class="table">
		<tr  bgcolor="${symbol_pound}EEEEEE">
			<th align="center" bgcolor="${symbol_pound}EEEEEE">文件名</th>
			<th align="center" bgcolor="${symbol_pound}EEEEEE">文件大小</th>
			<th align="center" bgcolor="${symbol_pound}EEEEEE">文件类型</th>
			<th align="center" bgcolor="${symbol_pound}EEEEEE">链接</th>
		</tr>
	</table>
