		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
							...
							<t:dictSelect field="siteTemplateStyle"  dictTable="weixin_cms_style where accountid = '${symbol_dollar}{sessionScope.WEIXIN_ACCOUNT.id}'" dictField="id" dictText="template_name" defaultVal="${symbol_dollar}{weixinCmsSitePage.siteTemsplateStyle}" ></t:dictSelect>
							<span class="Validform_checktip"></span>
