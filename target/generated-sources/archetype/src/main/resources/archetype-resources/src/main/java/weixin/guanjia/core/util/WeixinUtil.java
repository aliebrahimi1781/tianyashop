...
//    private static final ResourceBundle bundle  = ResourceBundle.getBundle("weixin");
    ...
    public static JSONObject httpRequest(String requestUrl, String requestMethod, String outputStr) {
        ...
        try {
        	...
        	${package}.core.util.LogUtil.info("Weixin server connection timed out.");
        } catch (Exception e) {
        	${package}.core.util.LogUtil.info("https request error:{}"+e.getMessage());
        }
        return jsonObject;
    }
        	...
        	if(end.getTime()-accessTocken.getAddTime().getTime()>accessTocken.getExpires_in()*1000){
                 ...
                 if (null != jsonObject) {
                     try {
                         ...
                         ${package}.core.util.LogUtil.info(wrongMessage);
                     }
                 }
                 return accessToken;
        	}else{
