...
if ( dir == null || "".equals( dir ) ) {
    ...
    response.getWriter().print( "{'state':'${symbol_escape}${symbol_escape}u975e${symbol_escape}${symbol_escape}u6cd5${symbol_escape}${symbol_escape}u4e0a${symbol_escape}${symbol_escape}u4f20${symbol_escape}${symbol_escape}u76ee${symbol_escape}${symbol_escape}u5f55'}" );
    return;
