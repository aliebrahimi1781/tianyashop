...
import ${package}.web.demo.entity.test.JeecgBlobDataEntity;
import ${package}.web.demo.entity.test.WebOfficeEntity;
import ${package}.web.demo.service.test.WebOfficeServiceI;
...
public class WebOfficeController extends BaseController {
	...
	public void datagrid(WebOfficeEntity webOffice,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		${package}.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, webOffice, request.getParameterMap());
