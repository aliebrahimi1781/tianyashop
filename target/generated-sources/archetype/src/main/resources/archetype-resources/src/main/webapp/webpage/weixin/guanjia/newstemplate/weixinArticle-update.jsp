...
${symbol_dollar}(function () {
    ...
    ${symbol_dollar}('${symbol_pound}fileupload').fileupload({
		...
		if (d.success) {
        	...
        	${symbol_dollar}("${symbol_pound}imagePath").val(d.attributes.url);
		}else{
        ...
        ${symbol_dollar}("${symbol_pound}saveButton").click(function(){
        
            ${symbol_dollar}("${symbol_pound}formobjNew").attr("action", "weixinArticleController.do?doUpdate");
        	${symbol_dollar}("${symbol_pound}formobjNew").submit();
					...
					<div class="appmsg_content" id="js_appmsg_preview">
							<h4 class="appmsg_title">
								<a target="_blank" href="javascript:void(0);"
									onclick="return false;">${symbol_dollar}{weixinArticle.title}</a>
							</h4>
							<div class="appmsg_info">
								<em class="appmsg_date"></em>
							</div>
							<div id="files" class="files">
								<i style="height:160px;overflow:hidden;display:inline-block;width:100%;"><img src="${symbol_dollar}{weixinArticle.imagePath}" width="100%" height="160" /></i>
							</div>
 			...
 			<div class="appmsg_editor" style="margin-top: 0px;">
	 			<div class="inner">
		  		<t:formvalid formid="formobjNew" dialog="true" usePlugin="password" layout="table" action="weixinArticleController.do?doUpdate" tiptype="1">
							<input id="id" name="id" type="hidden" value="${symbol_dollar}{weixinArticle.id }">
				<table style="width: 500px;" cellpadding="0" cellspacing="1" class="formtable">
						<tr>
							...
							<td class="value">
							     	 <input id="title" name="title" type="text" value="${symbol_dollar}{weixinArticle.title}" style="width: 300px" class="inputxt"  datatype="*">
						...
						<tr>
							...
							<td class="value">
							     	 <input id="author" name="author" value="${symbol_dollar}{weixinArticle.author}" type="text" style="width: 300px" class="inputxt" >
									<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								<span class="btn btn-success fileinput-button">
							        ...
							        <input id="imagePath" name=imagePath type="hidden" value="${symbol_dollar}{weixinArticle.imagePath}" datatype="*" nullmsg="请添加图片">
							    </span>
						...
						<tr>
							...
							<td class="value">
							     	 <input id="description" name="description" value="${symbol_dollar}{weixinArticle.description}" type="text" style="width: 300px" class="inputxt" >
									<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
							     	 <input id="url" name="url" type="text" style="width: 300px" class="inputxt" value="${symbol_dollar}{weixinArticle.url}" >
									<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								 <textarea name="content" id="content">${symbol_dollar}{weixinArticle.content}</textarea>
							    <script type="text/javascript">
						...
						<tr>
							...
							<td class="value">
							     	 <input id="orders" name="orders" type="text" style="width: 150px" class="inputxt" value="${symbol_dollar}{weixinArticle.orders}" datatype="*">
									<span class="Validform_checktip"></span>
