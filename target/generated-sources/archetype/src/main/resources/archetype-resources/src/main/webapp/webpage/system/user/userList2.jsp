...
<div style="float: left;"><a href="${symbol_pound}" id="add" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('用户录入','userController.do?addorupdate','userList2')">用户录入</a> <a href="${symbol_pound}"
...
<div align="right">用户名: <input class="easyui-validatebox" name="userName" style="width: 80px"> 真实姓名: <input class="easyui-validatebox" name="realName" style="width: 80px"> <a
	href="${symbol_pound}" class="easyui-linkbutton" iconCls="icon-search" onclick="userListsearch();">查询</a></div>
</div>
</div>
</div>
