...
<div region="center" style="padding: 1px;"><t:datagrid name="cgformButtonList" title="自定义按钮[${symbol_dollar}{tableName}]" actionUrl="cgformButtonController.do?datagrid&formId=${symbol_dollar}{formId}" idField="id" fit="true">
	...
	<t:dgDelOpt title="删除" url="cgformButtonController.do?del&id={id}&formId=${symbol_dollar}{formId}" />
	<t:dgToolBar title="录入" icon="icon-add" url="cgformButtonController.do?addorupdate&formId=${symbol_dollar}{formId}" funname="add"></t:dgToolBar>
