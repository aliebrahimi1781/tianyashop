...
<t:formvalid formid="formobj" dialog="false" layout="table" beforeSubmit="upload">
	<table cellpadding="0" width="100%" cellspacing="1" class="formtable">
		...
		<tr height="40">
			<td class="upload" colspan="6"><a href="${symbol_pound}" class="easyui-linkbutton" id="btn_sub" iconCls="icon-ok">上传</a> <a href="${symbol_pound}" class="easyui-linkbutton" id="btn_reset" iconCls="icon-back">重置</a> <a
