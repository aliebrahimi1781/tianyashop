...
public class DbTableProcess {
	...
	public static void createOrDropTable(CgFormHeadEntity table, Session session) throws IOException, TemplateException, HibernateException, SQLException, DBException  {
		Template t;
		t = getConfig("/${packageInPathFormat}/web/cgform/engine/hibernate").getTemplate("tableTemplate.ftl");
		Writer out = new StringWriter();
		//模板对于数字超过1000，会自动格式为1,,000(禁止转换)
		t.setNumberFormat("0.${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}");
