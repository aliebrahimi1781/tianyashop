...
//    	${package}.core.util.LogUtil.info("...opendId...."+opendId+"....hdId..."+id);
    ...
    public AjaxJson doGgl(HttpServletRequest request){
		...
		if(hdRecrdList.size()>0){
			...
			${package}.core.util.LogUtil.info("....total...."+total);
		...
		${package}.core.util.LogUtil.info(message);
		j.setMsg(message);
	    return j;
    }
	...
	public AjaxJson saveRecord(HttpServletRequest request) {
		...
		Timestamp nowTime = new Timestamp(new java.util.Date().getTime());
		${package}.core.util.LogUtil.info("....prize...."+prize);
	...
	public ModelAndView goZhuanpan(HttpServletRequest request){
		...
		${package}.core.util.LogUtil.info("....hdid...."+hdEntity.getId()+"...openId.."+openId);
