...
import ${package}.core.util.ImportUtil;
import ${package}.core.util.JSONHelper;
...
public class CommonController extends BaseController {
	...
	public ModelAndView openViewFile(HttpServletRequest request) {
		...
		String subclassname = oConvertUtils.getString(request.getParameter("subclassname"), "${package}.web.system.pojo.base.TSAttachment");
