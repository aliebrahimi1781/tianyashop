...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.core.extend.template;
...
public class Caculator {
	...
	static{
	dfd.applyPattern("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}.00");
	dfi.applyPattern("${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}${symbol_pound}");
	}
	class Item
    {
        boolean ops;
...
//					{
//						${package}.core.util.LogUtil.info(tt);
//					}
    ...
    public String transInfixToPosfix(String in)
    {
        ...
        for(int i=0;i<cin.length;i++)
        {
            ...
            case ')':
                ...
                if(!meetClose)
                {
                	${package}.core.util.LogUtil.info(in);
            ...
            default:
                ...
                try {
						...
						e.printStackTrace();
						${package}.core.util.LogUtil.info("cal数字生成错误！！");
					}
...
//        ${package}.core.util.LogUtil.info(calc.transInfixToPosfix("1+2*3+7.5-(4/2+8)/5"));
//        ${package}.core.util.LogUtil.info("value is:"+calc.calc());
        
//        ${package}.core.util.LogUtil.info(calc.transInfixToPosfix("110815.00047*2"));
//        ${package}.core.util.LogUtil.info("value is:"+calc.calc());
//        ${package}.core.util.LogUtil.info(calc.transInfixToPosfix("110815.125047*2"));
//        ${package}.core.util.LogUtil.info("value is:"+calc.calc());
        
//        ${package}.core.util.LogUtil.info(calc.transInfixToPosfix("((110815.0347)*2+10)/0"));
//        ${package}.core.util.LogUtil.info("value is:"+calc.calc());
        
        
//        ${package}.core.util.LogUtil.info(calc.transInfixToPosfix("0.02"));
//        ${package}.core.util.LogUtil.info("value is:"+calc.calc());
//        ${package}.core.util.LogUtil.info(calc.transInfixToPosfix("0.0"));
//        ${package}.core.util.LogUtil.info("value is:"+calc.calc());
       
       ${package}.core.util.LogUtil.info(calc.transInfixToPosfix("1.3E7+0.5"));   
       ${package}.core.util.LogUtil.info("value is:"+calc.calc());
        Double dd=Double.parseDouble("1.35378957E7");
        
        ${package}.core.util.LogUtil.info(Caculator.getDtoI(dd));
        
        ${package}.core.util.LogUtil.info(dd);
