...
public class BaiduTranslateService {
	...
	public static String translate(String source) {
		...
		// 组装查询地址
		String requestUrl = "http://openapi.baidu.com/public/${version}/bmt/translate?client_id=bm2FiTzH2WFHWlZdcLWHeO9R&q={keyWord}&from=auto&to=auto";
	...
	public static void main(String[] args) {
		...
		${package}.core.util.LogUtil.info(translate("网络真强大"));
	}
}
