...
public class CommUtils {
	...
	public static Map<String,List<Map<String,Object>>> mapConvertMore(Map map,String tableName) {
        ...
        if(map!=null){
	        ...
	        while(it.hasNext()){
                ...
                String keyArr[] = key.split("${symbol_escape}${symbol_escape}.");
    ...
    public static void main(String[] args) {
    	...
    	String strs [] = str.split("${symbol_escape}${symbol_escape}.");
    	${package}.core.util.LogUtil.info(strs.length+"");
    	${package}.core.util.LogUtil.info(strs[0].substring(0,strs[0].indexOf("[")));
	}
}
