...
public class WechatService {
	...
	public static String getTranslateUsage() {
		...
		buffer.append("微译使用指南").append("${symbol_escape}n${symbol_escape}n");
		buffer.append("微译为用户提供专业的多语言翻译服务，目前支持以下翻译方向：").append("${symbol_escape}n");
		buffer.append("    中 -> 英").append("${symbol_escape}n");
		buffer.append("    英 -> 中").append("${symbol_escape}n");
		buffer.append("    日 -> 中").append("${symbol_escape}n${symbol_escape}n");
		buffer.append("使用示例：").append("${symbol_escape}n");
		buffer.append("    翻译我是中国人").append("${symbol_escape}n");
		buffer.append("    翻译dream").append("${symbol_escape}n");
		buffer.append("    翻译さようなら").append("${symbol_escape}n${symbol_escape}n");
	...
	String doDingYueEventResponse(Map<String, String> requestMap,TextMessageResp textMessage ,ResourceBundle bundler,String respMessage
		...
		respContent = "谢谢您的关注！回复${symbol_escape}"?${symbol_escape}"进入主菜单。";
